	...
	if(suffix) {
        ...
        const getCommandHelp = (name, type, usage, description) => {
        	return {
				...
				value: `${description ? (`Description: ${description}\n`) : ""}${usage ? (`Usage: \`${usage}\`\n`) : ""}Click [here](https://echo-studios.co.uk/wiki/Commands#${name}) for more info`,
				inline: true
			};
		};
